          ...
          <div className="bg-white border border-stone-200 rounded-lg p-6 shadow-sm">
            ...
            <form onSubmit={handleUpdateOrder} className="space-y-4">
              ...
              <button
                type="submit"
                disabled={updating}
                className="px-5 py-2.5 bg-stone-900 hover:bg-stone-800 text-white rounded text-xs font-bold uppercase tracking-wider transition-colors flex items-center gap-2 disabled:opacity-50"
              >
