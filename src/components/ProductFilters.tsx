...
export default function ProductFilters({ categories, allTags }: ProductFiltersProps) {
  ...
  return (
    <aside className="w-full space-y-8 p-6 bg-[#F5EFE6]/30 border border-amber-900/5 rounded-lg text-amber-950">
      <div className="flex justify-between items-center border-b border-amber-950/10 pb-4">
